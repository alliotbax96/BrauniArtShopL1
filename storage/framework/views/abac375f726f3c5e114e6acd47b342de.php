            ...
            <div class="row align-items-center">
                <div class="col">
                    <div class="copyright-text">
                        <p><a href="/">БРАУНИАРТ МАГАЗИН</a> VER <?php echo e($verName); ?> | Все права защищены <?php echo e(date('Y')); ?> | Разработано <a
...
<div class="notification" style="position: fixed; top: 20px; right: 20px; padding: 15px 20px; background-color: #F44336; color: white; border-radius: 4px; z-index: 10000; box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 10px;"><?php echo e(session('error')); ?></div>
<script type="module">
...
<?php /**PATH /Users/artemnegladenko/Documents/dev/sites/LaravelProjects/BrauniartShopL1/resources/views/index.blade.php ENDPATH**/ ?>