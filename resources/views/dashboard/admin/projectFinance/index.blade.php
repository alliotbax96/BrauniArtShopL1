            ...
            <div class="main-content d-flex">
                ...
                <div class="content-sidebar content-sidebar-md" data-scrollbar-target="#psScrollbarInit">
                    ...
                    <div class="content-sidebar-header">
                        <a href="javascript:void(0);" class="btn btn-success w-100" data-bs-toggle="modal" data-bs-target="#addIncomeModal">
                            <i class="feather-plus-circle me-2"></i>
                            <span>Пополнить бюджет</span>
                        </a>
                        <a href="javascript:void(0);" class="btn btn-danger w-100" data-bs-toggle="modal" data-bs-target="#addExpenseModal">
                            ...
                            <div class="card bg-light">
                                <div class="card-body p-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="fs-5 fw-bold total-budget">{{ number_format($budget->total_budget, 2, '.', ' ') }} ₽</div>
                                    </div>

                                    <div class="mb-3">
                                        <small class="text-muted d-block">Текущий баланс:</small>
                                        <div class="fs-5 fw-bold current-balance {{ $budget->current_balance >= 0 ? 'text-success' : 'text-danger' }}">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        @if(auth()->id() === 1)
                                            <a href="javascript:void(0);" class="btn btn-sm btn-outline-primary mt-2" data-bs-toggle="modal" data-bs-target="#updateManagerBalanceModal">
                            ...
                            <div class="hstack gap-2">
                                <div class="hstack">
                                    <a href="javascript:void(0)" class="search-form-open-toggle">
                                        <div class="avatar-text avatar-md" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Поиск">
                                    ...
                                    <form class="search-form" style="display: none">
                                        <div class="search-form-inner">
                                            <a href="javascript:void(0)" class="search-form-close-toggle">
                                                <div class="avatar-text avatar-md" data-bs-toggle="tooltip" data-bs-trigger="hover" title="Закрыть">
                                                    <i class="feather-arrow-left"></i>
                                                </div>
                                            </a>
                                            <input type="search" class="py-3 px-0 border-0 w-100" id="transactionsSearch" placeholder="Поиск по описанию...">
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="incomeDescription"
                                   name="description" placeholder="Например: Оплата от клиента, инвестиции" required maxlength="255">
                    ...
                    <div class="modal-body">
                        <div class="mb-4">
                            ...
                            <div class="row g-2">
                                <div class="col-6 col-md-4">
                                    <input type="radio" class="btn-check" name="category" id="cat-development" value="development" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" id="expenseDescription"
                                   name="description" placeholder="Например: Оплата хостинга, зарплата разработчика" required maxlength="255">
                    ...
                    <form id="updateManagerBalanceForm" action="{{ route('admin.budget.manager-balance') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="alert alert-info">
                                ...
                                Текущий баланс: <strong>{{ number_format($budget->manager_balance, 2, '.', ' ') }} ₽</strong>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" min="0" class="form-control form-control-lg"
                                           id="newManagerBalance" name="new_balance" value="{{ $budget->manager_balance }}" required>
                                </div>
                                <small class="text-muted">
