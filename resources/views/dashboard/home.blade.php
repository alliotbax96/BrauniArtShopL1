                            ...
                            <div>
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <ul>
                                          <li>Добавлены новые сервисы доставки</li>
                                          <li>Отключены уведомления WhatsApp</li>
                                          <li>Добавлены уведомления в Telegram</li>
                                        </ul>
                                    </li>
                                    <li>
                                        <strong>
                                        ...
                                        <ul>
                                         <li>Введено ограничение на дробные цены.</li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
