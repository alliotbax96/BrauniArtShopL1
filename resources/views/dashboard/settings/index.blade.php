            ...
            <div class="card border-top-0">
                <div class="card-header p-0">
                    ...
                    <ul class="nav nav-tabs flex-wrap w-100 text-center customers-nav-tabs" id="myTab"
                        ...
                        <li class="nav-item flex-fill border-top " role="presentation">
                            <a href="javascript:void(0);"
                               class="nav-link @if(Route::currentRouteName() == 'seller.settings.logistic') active @endif" data-bs-toggle="tab"
                ...
                <div class="tab-content">
                    <div class="tab-pane fade @if(Route::currentRouteName() == 'seller.settings.index') show active @endif"
                        ...
                        <div class="card-body personal-info">
                            ...
                            <div class="row mb-4 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        <select form="seller_general" name="companyEntityDetails" id="companyEntityDetails" class="form-control">
                    ...
                    <div class="tab-pane fade @if(Route::currentRouteName() == 'seller.settings.logistic') show active @endif" id="billingTab"
                         role="tabpanel">
                        ...
                        <div class="card-body pass-security" id="user_address">
                            ...
                            <div class="row mb-4 align-items-center">
                                <div id="alert_profile"></div>
                                <div class="col-lg-4">
                                    <label for="pvzInput" class="fw-semibold">Пункт сдачи заказов до 200 килограмм:</label>
                                </div>
                                <div class="col-lg-8">
                                    <div class="input-group">
                    ...
                    <div class="tab-pane fade @if(Route::currentRouteName() == 'seller.settings.contract') show active @endif" id="contractTab"
                         role="tabpanel">
                        <div class="card-body pass-info">
                            <div class="mb-4 d-flex align-items-center justify-content-between">
                                <h5 class="fw-bold mb-0 me-4">
                        ...
                        <div class="card-body pass-security" id="user_address">
                            ...
                            <div class="hstack justify-content-between p-4 mb-3 border border-dashed border-gray-3 rounded-1">
                                ...
                                <div class="form-check form-switch form-switch-sm">
                                    ...
                                    <input class="form-check-input c-pointer" type="checkbox" id="formSwitch2FA" disabled @if(isset($contract) && $contract->status && $contract->signed_status) checked @endif>
                                </div>
                            </div>
                        </div>
                        @if(isset($contract) && (!$contract->status || !$contract->signed_status))
                        ...
                        <div class="card-body">
                            <div class="alert alert-info">
                                ...
                                @endif
                                @if(isset($contract) && !$contract->status && $contract->signed_status)
                                Рекомендуем обратиться в <a href="https://t.me/BrauniArtSellers" target="_blank">поддержку</a> для решения проблемы!
                                @endif
                            </div>
                        </div>
                        @endif
