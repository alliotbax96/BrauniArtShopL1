    ...
    return i.prototype = {
        constructor: i, setStartDate: function (t) {
            ...
            var e, a = (e = "left" == t ? this.leftCalendar : this.rightCalendar).month.month(), i = e.month.year(),
                s = e.month.hour(), n = e.month.minute(), r = e.month.second(), o = A([i, a]).daysInMonth(),
                h = A([i, a, 1]), i = A([i, a, o]), a = A(h).subtract(1, "month").month(),
                o = A(h).subtract(1, "month").year(), l = A([o, a]).daysInMonth(), c = h.day();
            ...
            if ("right" != t || this.endDate) {
                ...
                for (n = n + "</select> " + ': <select class="minuteselect">', h = 0; h < 60; h += this.timePickerIncrement) {
                    var m = h < 10 ? "0" + h : h, c = e.clone().minute(h), d = !1;
            ...
            var t, e = {top: 0, left: 0}, a = this.drops, i = L(window).width();
            ...
            var t = L(t.target).closest(".drp-calendar").hasClass("left"),
                ...
                a = parseInt(e.find(".monthselect").val(), 10), e = e.find(".yearselect").val();
            ...
            var t = L(t.target).closest(".drp-calendar"), e = t.hasClass("left"),
                a = parseInt(t.find(".hourselect").val(), 10), i = parseInt(t.find(".minuteselect").val(), 10),
