! function(n) {
    ...
    function l(t, e, n) {
        ...
        return h(t) || (e && a && (t = $(t, e)), n && a && (t = t.replace(G, "")), !isNaN(parseFloat(t)) && isFinite(t))
    }

    function a(t, e, n) {
        var a;
        return h(t) || (h(a = t) || "string" == typeof a) && l(t.replace(X, ""), e, n)
    }
    ...
    var p, e, t, C = function(t, v) {
            ...
            var e, y = this,
                D = v === N,
                _ = this.length;
            for (e in D && (v = {}), this.oApi = this.internal = p.internal, C.ext.internal) e && (this[e] = qe(e));
            return this.each(function() {
                ...
                if ("table" != this.nodeName.toLowerCase()) W(null, 0, "Non-table node initialisation (" + this.nodeName + ")", 2);
                    ...
                    if (0 !== (t = this.getElementsByTagName("thead")).length && (Ct(h.aoHeader, t[0]), m = wt(h)), null === r.aoColumns)
                    ...
                    var S = h.oFeatures,
                        t = function() {
                            ...
                            if (0 === a.length && (a = P("<tbody/>").insertAfter(n)), h.nTBody = a[0], 0 === (n = 0 === (n = l.children("tfoot")).length && 0 < e.length && ("" !== h.oScroll.sX || "" !== h.oScroll.sY) ? P("<tfoot/>").appendTo(l) : n).length || 0 === n.children().length ? l.addClass(p.sNoFooter) : 0 < n.length && (h.nTFoot = n[0], Ct(h.aoFooter, h.nTFoot)), r.aaData)
    ...
    function nt(t, e) {
        ...
        t.aoColumns.push(n), (n = t.aoPreSearchCols)[a] = P.extend({}, C.models.oSearch, n[a]), at(t, a, P(e).data())
    }
    ...
    function lt(t) {
        for (var e, n, a, r, o, i, l, s = t.aoColumns, u = t.aoData, c = C.ext.type.detect, f = 0, d = s.length; f < d; f++)
            ...
            for (e = 0, n = c.length; e < n; e++) {
                for (a = 0, r = u.length; a < r && (l[a] === N && (l[a] = v(t, a, f, "type")), (i = c[e](l[a], t)) || e === c.length - 1) && ("html" !== i || h(l[a])); a++);
                if (i) {
                    o.sType = i;
                    break
                }
    ...
    function x(t, e, n, a) {
        ...
        return t.aiDisplayMaster.push(r), (e = t.rowIdFn(e)) !== N && (t.aIds[e] = o), !n && t.oFeatures.bDeferRender || St(t, r, n, a), r
    }
    ...
    function mt(t, e, n, a) {
        ...
        return (e = (e = e.firstChild ? e : e.nTr) && e.getAttribute("id")) && b(t.rowId)(a, e), {
            data: a,
            cells: u
        }
    }
    ...
    function St(t, e, n, a) {
        var r, o, i, l, s, u, c = t.aoData[e],
            ...
            d = [];
        if (null === c.nTr) {
            for (r = n || S.createElement("tr"), c.nTr = r, c.anCells = d, r._DT_RowIndex = e, vt(t, c), l = 0, s = t.aoColumns.length; l < s; l++) i = t.aoColumns[l], (o = (u = !n) ? S.createElement(i.sCellType) : a[l]) || W(t, 0, "Incorrect column count", 18), o._DT_CellIndex = {
                row: e,
                column: l
            }, d.push(o), !u && (!i.mRender && i.mData === l || P.isPlainObject(i.mData) && i.mData._ === l + ".display") || (o.innerHTML = v(t, e, l, "display")), i.sClass && (o.className += " " + i.sClass), i.bVisible && !n ? r.appendChild(o) : !i.bVisible && n && o.parentNode.removeChild(o), i.fnCreatedCell && i.fnCreatedCell.call(t.oInstance, o, v(t, e, l), f, e, l);
    ...
    function vt(t, e) {
        var n = e.nTr,
            a = e._aData;
        n && ((t = t.rowIdFn(a)) && (n.id = t), a.DT_RowClass && (t = a.DT_RowClass.split(" "), e.__rowc = e.__rowc ? Y(e.__rowc.concat(t)) : t, P(n).removeClass(e.__rowc.join(" ")).addClass(a.DT_RowClass)), a.DT_RowAttr && P(n).attr(a.DT_RowAttr), a.DT_RowData) && P(n).data(a.DT_RowData)
    }
    ...
    function y(t, e) {
        ...
        if (-1 !== P.inArray(!1, n)) D(t, !1);
            ...
            if (0 !== u.length)
                ...
                } else e = l.sZeroRecords, 1 == t.iDraw && "ajax" == E(t) ? e = l.sLoadingRecords : l.sEmptyTable && 0 === t.fnRecordsTotal() && (e = l.sEmptyTable), a[0] = P("<tr/>", {
                    class: i ? o[0] : ""
                }).append(P("<td />", {
                    valign: "top",
                    colSpan: T(t),
            ...
            R(t, "aoHeaderCallback", "header", [P(t.nTHead).children("tr")[0], ht(t), n, c, u]), R(t, "aoFooterCallback", "footer", [P(t.nTFoot).children("tr")[0], ht(t), n, c, u]), (s = P(t.nTBody)).children().detach(), s.append(P(a)), R(t, "aoDrawCallback", "draw", [t]), t.bSorted = !1, t.bFiltered = !1, t.bDrawing = !1
        }
    }
    ...
    function u(t, e) {
        var n = (a = t.oFeatures).bSort,
            a = a.bFilter;
        n && ie(t), a ? Rt(t, t.oPreviousSearch) : t.aiDisplay = t.aiDisplayMaster.slice(), !0 !== e && (t._iDisplayStart = 0), t._drawHold = e, y(t), t._drawHold = !1
    }
    ...
    function Ct(n, t) {
        var e, a, r, o, i, l, s, u, c, f, d = P(t).children("tr");
        ...
        for (r = 0, l = d.length; r < l; r++)
            for (a = (e = d[r]).firstChild; a;) {
                if ("TD" == a.nodeName.toUpperCase() || "TH" == a.nodeName.toUpperCase())
                    for (u = (u = +a.getAttribute("colspan")) && 0 != u && 1 != u ? u : 1, c = (c = +a.getAttribute("rowspan")) && 0 != c && 1 != c ? c : 1, s = function(t) {
                            for (var e = n[r]; e[t];) t++;
                            return t
                        }(0), f = 1 == u, i = 0; i < u; i++)
                        for (o = 0; o < c; o++) n[r + o][s + i] = {
                            cell: a,
                            unique: f
                        }, n[r + o].nTr = e;
                a = a.nextSibling
    ...
    function At(t) {
        ...
        return i.bFilter && (h("sSearch", l.sSearch), h("bRegex", l.bRegex)), i.bSort && (P.each(c, function(t, e) {
            p.order.push({
                column: e.col,
                dir: e.dir
            }), h("iSortCol_" + t, e.col), h("sSortDir_" + t, e.dir)
        }), h("iSortingCols", c.length)), null === (f = C.ext.legacy.ajax) ? t.sAjaxSource ? u : p : f ? u : p
    }
    ...
    function Ft(t, e, n) {
        if (t = P.isPlainObject(t.ajax) && t.ajax.dataSrc !== N ? t.ajax.dataSrc : t.sAjaxDataProp, !n) return "data" === t ? e.aaData || e[t] : "" !== t ? A(t)(e) : e;
        b(t)(e, n)
    }
    ...
    function Ht(t, e, n, a) {
        return t = e ? t : Ot(t), n && (t = "^(?=.*?" + P.map(t.match(/"[^"]+"|[^ ]+/g) || [""], function(t) {
            var e;
            return (t = '"' === t.charAt(0) && (e = t.match(/^"(.*)"$/)) ? e[1] : t).replace('"', "")
    ...
    function Wt(t) {
        for (var e, n, a, r, o, i = t.aoColumns, l = !1, s = 0, u = t.aoData.length; s < u; s++)
            if (!(o = t.aoData[s])._aFilterData) {
                for (a = [], e = 0, n = i.length; e < n; e++) i[e].bSearchable ? "string" != typeof(r = null === (r = v(t, s, e, "filter")) ? "" : r) && r.toString && (r = r.toString()) : r = "", r.indexOf && -1 !== r.indexOf("&") && (Mt.innerHTML = r, r = kt ? Mt.textContent : Mt.innerText), r.replace && (r = r.replace(/[\r\n\u2028]/g, "")), a.push(r);
    ...
    function Jt(n) {
        ...
        if (n.bInitialised) {
            ...
            R(n, null, "preInit", [n]), u(n), "ssp" == (i = E(n)) && !l || ("ajax" == i ? Tt(n, [], function(t) {
                var e = Ft(n, t);
    ...
    function Yt(t, e, n) {
        var a = t._iDisplayStart,
            r = t._iDisplayLength,
            o = (0 === (o = t.fnRecordsDisplay()) || -1 === r ? a = 0 : "number" == typeof e ? o < (a = e * r) && (a = 0) : "first" == e ? a = 0 : "previous" == e ? (a = 0 <= r ? a - r : 0) < 0 && (a = 0) : "next" == e ? a + r < o && (a += r) : "last" == e ? a = Math.floor((o - 1) / r) * r : W(t, 0, "Unknown paging action: " + e, 5), t._iDisplayStart !== a);
    ...
    function Qt(n) {
        ...
        var e, a, r, o, i, l = (c = n.oScroll).sX,
            s = c.sXInner,
            u = c.sY,
            c = c.iBarWidth,
            f = P(n.nScrollHead),
        ...
        n.scrollBarVis !== R && n.scrollBarVis !== N ? (n.scrollBarVis = R, O(n)) : (n.scrollBarVis = R, D.children("thead, tfoot").remove(), w && (R = w.clone().prependTo(D), i = w.find("tr"), a = R.find("tr"), R.find("[id]").removeAttr("id")), R = y.clone().prependTo(D), y = y.find("tr"), e = R.find("tr"), R.find("th, td").removeAttr("tabindex"), R.find("[id]").removeAttr("id"), l || (m.width = "100%", f[0].style.width = "100%"), P.each(wt(n, R), function(t, e) {
            r = rt(n, t), e.style.width = n.aoColumns[r].sWidth
        }), w && M(function(t) {
            t.style.width = ""
        }, a), f = D.outerWidth(), "" === l ? (C.width = "100%", x && (D.find("tbody").height() > g.offsetHeight || "scroll" == b.css("overflow-y")) && (C.width = k(D.outerWidth() - c)), f = D.outerWidth()) : "" !== s && (C.width = k(s), f = D.outerWidth()), M(t, e), M(function(t) {
    ...
    function ee(t) {
        var e, n, a = t.nTable,
            ...
            p = t.oBrowser,
            g = p.bScrollOversize;
        for ((m = a.style.width) && -1 !== m.indexOf("%") && (f = m), D = 0; D < u.length; D++) null !== (e = r[u[D]]).sWidth && (e.sWidth = ae(e.sWidthOrig, d), h = !0);
        if (g || !h && !i && !o && s == T(t) && s == c.length)
            for (D = 0; D < s; D++) {
                var b = rt(t, D);
                null !== b && (r[b].sWidth = k(c.eq(D).width()))
            } else {
                (m = P(a).clone().css("visibility", "hidden").removeAttr("id")).find("tbody tr").remove();
                var m, S = P("<tr/>").appendTo(m.find("tbody"));
                for (m.find("thead, tfoot").remove(), m.append(P(t.nTHead).clone()).append(P(t.nTFoot).clone()), m.find("tfoot th, tfoot td").css("width", ""), c = wt(t, m.find("thead")[0]), D = 0; D < u.length; D++) e = r[u[D]], c[D].style.width = null !== e.sWidthOrig && "" !== e.sWidthOrig ? k(e.sWidthOrig) : "", e.sWidthOrig && i && P(c[D]).append(P("<div/>").css({
                    width: e.sWidthOrig,
                    margin: 0,
                    padding: 0,
                    border: 0,
                ...
                for (var v = P("<div/>").css(i || o ? {
                        ...
                        right: 0,
                        overflow: "hidden"
                    } : {}).append(m).appendTo(d), y = (i && l ? m.width(l) : i ? (m.css("width", "auto"), m.removeAttr("width"), m.width() < d.clientWidth && f && m.width(d.clientWidth)) : o ? m.width(d.clientWidth) : f && m.width(f), 0), D = 0; D < u.length; D++) {
                    var _ = P(c[D]),
                        C = _.outerWidth() - _.width();
                    y += _ = p.bBounding ? Math.ceil(c[D].getBoundingClientRect().width) : _.outerWidth(), r[u[D]].sWidth = k(_ - C)
                }
                a.style.width = k(y), v.remove()
            }
        f && (a.style.width = k(f)), !f && !i || t._reszEvt || (l = function() {
            P(j).on("resize.DT-" + t.sInstance, ne(function() {
                O(t)
            }))
        }, g ? setTimeout(l, 1e3) : l(), t._reszEvt = !0)
    }
    var ne = C.util.throttle;

    function ae(t, e) {
        return t ? (e = (t = P("<div/>").css("width", k(t)).appendTo(e || S.body))[0].offsetWidth, t.remove(), e) : 0
    }

    function re(t, e) {
        var n, a = oe(t, e);
        return a < 0 ? null : (n = t.aoData[a]).nTr ? n.anCells[e] : P("<td/>").html(v(t, a, e, "display"))[0]
    }

    function oe(t, e) {
        for (var n, a = -1, r = -1, o = 0, i = t.aoData.length; o < i; o++)(n = (n = (n = v(t, o, e, "display") + "").replace(te, "")).replace(/&nbsp;/g, " ")).length > a && (a = n.length, r = o);
        return r
    }
    ...
    function fe(t, e) {
        for (var n, a, r, o = t.aoColumns[e], i = C.ext.order[o.sSortDataType], l = (i && (n = i.call(t.oInstance, t, e, ot(t, e))), C.ext.type.order[o.sType + "-pre"]), s = 0, u = t.aoData.length; s < u; s++)(a = t.aoData[s])._aSortData || (a._aSortData = []), a._aSortData[e] && !i || (r = i ? n[s] : v(t, s, e, "sort"), a._aSortData[e] = l ? l(r) : r)
    }
    ...
    function W(t, e, n, a) {
        ...
        else if (e = (e = C.ext).sErrMode || e.errMode, t && R(t, null, "error", [t, a, n]), "alert" == e) alert(n);
        else {
    ...
    function we(i, t, e, n) {
        ...
        (function t(e, n) {
            ...
            else e.nodeName && "tr" === e.nodeName.toLowerCase() ? l.push(e) : (a = P("<tr><td></td></tr>").addClass(n), P("td", a).addClass(n).html(e)[0].colSpan = T(i), l.push(a[0]))
        })(e, n), t._details && t._details.detach(), t._details = P(l), t._detailsShow && t._details.insertAfter(t.nTr)
    }

    function Te(t, e) {
        var s, r, n, u, a = t.context;
        a.length && t.length && (n = a[0].aoData[t[0]])._details && ((n._detailsShow = e) ? (n._details.insertAfter(n.nTr), P(n.nTr).addClass("dt-hasChild")) : (n._details.detach(), P(n.nTr).removeClass("dt-hasChild")), R(a[0], null, "childRow", [e, t.row(t[0])]), s = a[0], r = new B(s), e = "draw" + (n = ".dt.DT_details"), u = s.aoData, r.off(e + " " + (t = "column-sizing" + n) + " " + (n = "destroy" + n)), 0 < H(u, "_details").length && (r.on(e, function(t, e) {
            s === e && r.rows({
                page: "current"
            ...
            if (s === e)
                for (var r, o = T(e), i = 0, l = u.length; i < l; i++)(r = u[i])._details && r._details.children("td[colspan]").attr("colspan", o)
        }), r.on(n, function(t, e) {
            if (s === e)
    ...
    var Ie = [],
        ...
        Fe = (C.Api = B, P.extend(B.prototype, {
            ...
            return t !== N && null !== t ? new B(function e(t, n) {
                var a;
        ...
        Le = (e("rows()", function(e, n) {
            e === N ? e = "" : P.isPlainObject(e) && (n = e, e = ""), n = _e(n);
            var t = this.iterator("table", function(t) {
                return De("row", e, function(n) {
                    ...
                    return t = _(m(r.aoData, i, "nTr")), P(t).filter(n).map(function() {
            ...
            return this.iterator("row", function(t, e, n) {
                ...
                gt(t.aiDisplayMaster, e), gt(t.aiDisplay, e), gt(f[n], e, !1), 0 < t._iRecordsDisplay && t._iRecordsDisplay--, Se(t), (n = t.rowIdFn(c._aData)) !== N && delete t.aIds[n]
            ...
            n.on(r, function(t, e, n) {
                ...
                n.off(r + " " + o)
            }), (a = n.state.loaded()) && a.childRows && n.rows(P.map(a.childRows, function(t) {
                return t.replace(/:/g, "\\:")
            })).every(function() {
        ...
        Re = "row().child",
        Pe = Re + "()",
        je = (e(Pe, function(t, e) {
            var n = this.context;
            return t === N ? n.length && this.length ? n[0].aoData[this[0]]._details : N : (!0 === t ? this.child.show() : !1 === t ? Ae(this) : n.length && this.length && we(n[0], n[0].aoData[this[0]], t, e), this)
        ...
        Ne = (e("columns()", function(n, a) {
            n === N ? n = "" : P.isPlainObject(n) && (a = n, n = ""), a = _e(a);
            var t = this.iterator("table", function(t) {
                return e = n, l = a, s = (i = t).aoColumns, u = H(s, "sName"), c = H(s, "nTh"), De("column", e, function(n) {
                    var a, t = d(n);
            ...
            return P.isPlainObject(g) && (g.row === N ? (b = g, g = null) : (b = t, t = null)), P.isPlainObject(t) && (b = t, t = null), null === t || t === N ? this.iterator("table", function(t) {
                return a = t, t = g, e = _e(b), f = a.aoData, d = Fe(a, e), n = _(m(f, d, "anCells")), h = P(U([], n)), p = a.aoColumns.length, De("cell", t, function(t) {
                    ...
                    if (null === t || t === N || n) {
                        for (o = [], i = 0, l = d.length; i < l; i++)
                            for (r = d[i], s = 0; s < p; s++) u = {
                                row: r,
                                column: s
                            }, n && (c = f[r], !t(u, v(a, r, s), c.anCells ? c.anCells[s] : null)) || o.push(u);
                        return o
                    }
            ...
            var e = this.context,
                n = this[0];
            return t === N ? e.length && n.length ? v(e[0], n[0].row, n[0].column) : N : (ct(e[0], n[0].row, n[0].column, t), bt(e[0], n[0].row, "data", n[0].column), this)
            ...
            return c = c || !1, this.iterator("table", function(e) {
                ...
                l[o = c ? "remove" : "detach"](), s[o](), !c && i && (i.insertBefore(a, e.nTableReinsertBefore), l.css("width", e.sDestroyWidth).removeClass(t.sTable), n = e.asDestroyStripes.length) && r.children().each(function(t) {
            ...
            return (t = A(t)(a.oLanguage)) === N && (t = e), (t = n !== N && P.isPlainObject(t) ? t[n] !== N ? t[n] : t._ : t).replace("%d", n)
            ...
            oLanguage: {
                ...
                sEmptyTable: "Ни одной записи не найдено",
                sInfo: "Показны с _START_ по _END_ из _TOTAL_ записей",
    ...
    function Oe(t, e, n, a) {
        return 0 === t || t && "-" !== t ? +((t = e ? $(t, e) : t).replace && (n && (t = t.replace(n, "")), a) ? t.replace(a, "") : t) : -1 / 0
    }
    ...
    P.extend(Ne, {
        ...
        pageButton: {
            _: function(u, t, c, e, f, d) {
                ...
                } catch (t) {}(function t(e, n) {
                    for (var a, r, o = g.sPageButtonDisabled, i = function(t) {
                            Yt(u, t.data.action, !0)
                        }, l = 0, s = n.length; l < s; l++)
                        if (a = n[l], Array.isArray(a)) t(P("<" + (a.DT_el || "div") + "/>").appendTo(e), a);
                        else {
                            switch (h = null, p = a, r = u.iTabIndex, a) {
                                ...
                                case "previous":
                                    ...
                                    break;
                                case "next":
                                    h = b.sNext, 0 !== d && f !== d - 1 || (r = -1, p += " " + o);
                                    break;
                                case "last":
                                    h = b.sLast, 0 !== d && f !== d - 1 || (r = -1, p += " " + o);
                                    break;
                                default:
                ...
                })(P(t).empty(), e), n !== N && P(t).find("[data-dt-idx=" + n + "]").trigger("focus")
            }
        }
        ...
        var n;
        return (!t || t instanceof Date || J.test(t)) && (null !== (n = Date.parse(t)) && !isNaN(n) || h(t)) ? "date" : null
    }, function(t, e) {
        ...
        html: function(t) {
            return h(t) ? t : "string" == typeof t ? t.replace(V, " ").replace(X, "") : ""
        },
        string: function(t) {
    ...
    function Be(t, e, n) {
        ...
        if (j.moment) {
            ...
            a.setLocale(n)
        } else e ? (Ee || alert("DataTables warning: Formatted date without Moment.js or Luxon - https://datatables.net/tn/17"), Ee = !0) : a = new Date(t);
        return a
    }
    ...
    var Ve = ",",
        Xe = ".";
    if (Intl) try {
        for (var Je = (new Intl.NumberFormat).formatToParts(100000.1), n = 0; n < Je.length; n++) "group" === Je[n].type ? Ve = Je[n].value : "decimal" === Je[n].type && (Xe = Je[n].value)
    } catch (t) {}
    ...
    return C.datetime = function(n, a) {
        ...
        number: function(a, r, o, i, l) {
            return null !== a && a !== N || (a = Ve), null !== r && r !== N || (r = Xe), {
                display: function(t) {
                    var e, n;
                    return "number" != typeof t && "string" != typeof t || "" === t || null === t ? t : (e = t < 0 ? "-" : "", n = parseFloat(t), isNaN(n) ? ke(t) : (n = n.toFixed(o), t = Math.abs(n), n = parseInt(t, 10), t = o ? r + (t - n).toFixed(o).substring(2) : "", (e = 0 === n && 0 === parseFloat(t) ? "" : e) + (i || "") + n.toString().replace(/\B(?=(\d{3})+(?!\d))/g, a) + t + (l || "")))
                }
            }
        },
        text: function() {
